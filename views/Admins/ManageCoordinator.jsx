                      ...
                      {userData
                        ?.filter(
                          (item) =>
                            ...
                            item.secondaryRole === "Junior Coordinator" ||
                            item.secondaryRole === "Senior Coordinator"
                        )
                        .map((item, idx) => (
                          <tr key={item._id}>
                              ...
                              <div className="flex items-center gap-3">
                                <div className="avatar">
                                  <div className="mask mask-squircle w-12 h-12">
                                    <img src={item?.avatar?.secure_url?.src || item?.avatar?.secure_url || "https://cdn-icons-png.flaticon.com/512/149/149071.png"} />
                                  </div>
                                </div>
                                <div>
                            ...
                            <td className="px-6 py-4 whitespace-nowrap">
                              <span className="badge badge-info badge-md text-white bg-pink-900">
                                {item.role}/{item.secondaryRole}
                              </span>
                            </td>
                            <td className="px-6 py-4 whitespace-nowrap">
                              {item.number}
